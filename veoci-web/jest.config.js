...
module.exports = {
  ...
  // cacheDirectory: "/run/flatpak/app/com.jetbrains.IntelliJ-IDEA-Ultimate/jest_rs",
  ...
  moduleNameMapper: {
    ...
    '@store': '<rootDir>/src/veoci-store/veoci-store.js',
    '^@/(.*)$': '<rootDir>/src/$1',
    '^@node(.*)$': '<rootDir>/node_modules$1',
    '^@shared(.*)$': '<rootDir>/../veoci-shared$1',
    '^@veocijs(.*)$': '<rootDir>/../veoci-js/dist$1',
  },
